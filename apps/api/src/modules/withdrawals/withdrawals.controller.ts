...
export class WithdrawalsController {
  ...
  createMemberRequest(@CurrentUser() user: any, @Body() body: CreateWithdrawalRequestDto) {
    return this.withdrawalsService.createMemberRequest(user.id, body);
  }
  ...
  completeRequest(@Param('id') id: string, @CurrentUser() user: any, @Body() body: ReviewWithdrawalRequestDto, @Req() req: any) {
    return this.withdrawalsService.completeRequest(id, user, body, this.meta(req));
  }

  @UseGuards(AdminAuthGuard)
  @Post('admin/withdrawals/:id/reject')
  rejectRequest(@Param('id') id: string, @CurrentUser() user: any, @Body() body: ReviewWithdrawalRequestDto, @Req() req: any) {
