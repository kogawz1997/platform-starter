    ...
    <section className="casino-shell" style={{ '--casino-brand': props.primaryColor, '--casino-card': props.cardColor, color: props.textColor } as any}>
      ...
      <section className="casino-main-layout">
        ...
        <div className="casino-content">
          ...
          <div className="casino-announcement"><span>📣</span><div className="casino-marquee"><span>ยินดีต้อนรับสู่ {props.siteName} ฝาก-ถอนรวดเร็ว โปรโมชั่นและกิจกรรมอัปเดตทุกวัน</span></div></div>
