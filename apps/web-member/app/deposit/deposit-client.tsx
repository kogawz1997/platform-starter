...
function accountCountText(count: number) { return count === 1 ? '1 บัญชีพร้อมใช้งาน' : `${count} บัญชี ระบบจะสลับให้เอง`; }
