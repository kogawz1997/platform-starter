...
export default function AdminTopUpsPage() {
  ...
  async function reviewItem(id: string, action: 'confirm' | 'decline') {
    ...
    setPendingAction(null); setReviewNote(''); setMessage(action === 'confirm' ? 'อนุมัติสำเร็จ' : 'ปฏิเสธรายการแล้ว');
  }
