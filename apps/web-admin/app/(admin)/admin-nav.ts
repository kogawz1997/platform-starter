export const navGroups = [
  ...
  { title: 'Game Platform', items: [['Game Providers', '/game-providers'], ['Game API Settings', '/game-api-settings'], ['Game Catalog', '/games'], ['Game Sessions', '/game-sessions'], ['Game Transfers', '/game-transfers'], ['Webhook Logs', '/webhook-logs'], ['Provider Adapters', '/provider-adapters']] },
