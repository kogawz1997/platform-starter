export const navGroups = [
  ...
  { title: 'สินค้า/การตลาด', items: [['ศูนย์ฟีเจอร์สินค้า', '/growth-center'], ['โปรโมชัน/โบนัส', '/promotion-center'], ['คำขอรับโปร', '/promotion-claims'], ['Bonus Ledger', '/bonus-ledgers'], ['ตัวแทน/Affiliate', '/affiliate-center'], ['CMS/คอนเทนต์', '/content-center'], ['KYC/ตรวจบัญชี', '/kyc-center'], ['Support', '/support-center']] },
